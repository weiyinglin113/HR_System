...
<c:if test = '${!(sessionScope.user.role.equals("人事专员")||sessionScope.user.role.equals("人事经理"))}'>
    <div class = "msg">
        ...
        <table>
            <tr>
                ...
                <td style = "width: 180px">
                    <select id = "first" name = "first_mechaId"required="required" onchange = "changeSecond()"
                ...
                <td style = "width: 180px">
                    <select id = "second" name = "second_mechaId"required="required" onchange = "changeThird()"
                            style = "width: 100%; height: 25px">
                ...
                <td style = "width: 180px">
                    <select id = "third" name = "third_mechaId"required="required" style = "width: 100%; height: 25px">
                        <option value = "0">请选择</option>
            ...
            <tr>
                <td>职位分类</td>
                <td>
                    <select id = "job_cla" name = "job_classId"required="required" onchange = "changeJob()"
                            style = "width: 100%; height: 25px">
                        <option>请选择</option>
                ...
                <td>职位名称</td>
                <td>
                    <select id = "job" name = "jobId"required="required" style = "width: 100%; height: 25px">
                        <option value = "0">请选择</option>
                ...
                <td>职称</td>
                <td>
                    <select name = "ptId"required="required" style = "width: 100%; height: 25px">
                        <option>请选择</option>
                ...
                <td>学历专业</td>
                <td>
                    <select name = "majorId"required="required" style = "width: 100%; height: 25px">
                        <option>请选择</option>
            ...
            <tr>
                <td>姓名</td>
                <td>
                    <input type = "text" name = "name" required="required" style = "width: 100%; height: 25px">
                </td>

                <td>性别</td>
                <td>
                    <select name = "gender" required="required" style = "width: 100%; height: 25px">
                        <option>请选择</option>
                ...
                <td>身份证号码</td>
                <td>
                    <input type = "text" name = "IDCard"required="required" style = "width: 100%; height: 25px">
                </td>

                <td>民族</td>
                <td>
                    <select name = "nationId"required="required" style = "width: 100%; height: 25px">
                        <option>请选择</option>
            ...
            <tr>
                <td>薪酬标准</td>
                <td>
                    <select name = "salaryId"required="required" style = "width: 100%; height: 25px ;" >
                        <option  value='' >请选择</option>
                        <option index="1"value="160000001">软件设计师/6000</option>
                        <option index="2"value="160000002">软件分析师/8000</option>
                        <option index="3"value="160000003">信息安全工程师/8000</option>
                        <option index="4"value="160000004">运维工程师/7000</option>
                        <option index="5"value="160000005">项目经理/9000</option>
                        <option index="6"value="160000006">软件架构师/12000</option>
                        <option index="7"value="160000007">数据库管理员/6000</option>
                        <option index="8"value="160000008">测试工程师/7500</option>
                        <option index="9"value="160000009">销售经理/8000</option>
                        <option index="10"value="1600000010">销售助理/5500</option>
                    </select>
                </td>

                <td>开户行</td>
                <td>
                    <input type = "text" name = "bank" required="required" style = "width: 100%; height: 25px">
                </td>

                <td>账号</td>
                <td>
                    <input type = "text" name = "bank_card" required="required" style = "width: 100%; height: 25px">
                </td>
            ...
            <tr>
                <td>年龄</td>
                <td>
                    <input type = "text" name = "age"required="required" style = "width: 100%; height: 25px">
                </td>
                ...
                <td>EMAIL</td>
                <td colspan = "3">
                    <input type = "text" name = "email" required="required" style = "width: 100%; height: 25px">
                </td>
            ...
            <tr>
                <td>住址</td>
                <td colspan = "3">
                    <input type = "text" id = "address" name = "address"required="required" style = "width: 100%; height: 25px">
                </td>

                <td>手机</td>
                <td colspan = "3">
                    <input type = "text" name = "mobilephone"required="required" style = "width: 100%; height: 25px">
                </td>
            ...
            <tr>
                ...
                <td colspan = "7" style = "width: 1000px">
                    <textarea name = "resume"required="required" style = "width: 100%; height: 60px; resize: none"></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td>家庭关系信息</td>
                <td colspan = "7">
                    <textarea name = "family_relation"required="required" style = "width: 100%; height: 60px; resize: none"></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td>备注</td>
                <td colspan = "7">
                    <textarea name = "remarks"required="required" style = "width: 100%; height: 60px; resize: none"></textarea>
                </td>
            </tr>
