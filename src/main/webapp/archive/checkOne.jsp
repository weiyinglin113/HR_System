    ...
    <form action = "userInfo/passCheck" method = "post">
        <table>
            ...
            <tr>
                <td>薪酬标准</td>
                <td>
                    <select name = "salaryId" id ="salaryName" style = "width: 100%; height: 25px;" >
                        <option >请选择</option>
                        <option value="160000001">软件设计师/6000</option>
                        <option value="160000002">软件分析师/8000</option>
                        <option value="160000003">信息安全工程师/8000</option>
                        <option value="160000004">运维工程师/7000</option>
                        <option value="160000005">项目经理/9000</option>
                        <option value="160000006">软件架构师/12000</option>
                        <option value="160000007">数据库管理员/6000</option>
                        <option value="160000008">测试工程师/7500</option>
                        <option value="160000009">销售经理/8000</option>
                        <option value="1600000010">销售助理/5500</option>
                    </select>
                </td>
...
<script>
    ...
    function checkOption()
    {
        ...
        for (var i = 160000001; i < 160000011; i++)
        {
