...
<div class = "success">
    <c:if test = "${!empty addSuccess}">
        <p>添加成功！<a href = "archive/register.jsp">返回</a></p>
    </c:if>

    <c:if test = "${!empty checkSuccess}">
        <p>复核成功！<a href = "userInfo/check">返回</a></p>
    </c:if>

    <c:if test = "${!empty updateSuccess}">
        <p>更新成功！<a href = "archive/update.jsp">返回查询页面</a></p>
    </c:if>

    <c:if test = "${!empty deleteSuccess}">
        <p>更新成功！<a href = "archive/delete.jsp">返回查询页面</a></p>
    </c:if>

    <c:if test = "${!empty recoverSuccess}">
        <p>恢复成功！<a href = "archive/delete.jsp">返回查询页面</a></p>
    </c:if>
