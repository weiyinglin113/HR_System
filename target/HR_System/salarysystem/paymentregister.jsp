...
<div class = "main">
    <p class = "first-p">您正在做的业务是：人力资源>>薪资发放管理>>薪资发放登记</p>

    <c:if test = '${!sessionScope.user.role.equals("薪资专员"||"薪资经理")}'>
        <div class = "msg">
    ...
    <c:if test = '${sessionScope.user.role.equals("薪资专员"||"薪资经理")}'>
        <c:if test = "${empty checkUserList}">
            <div class = "msg">
                <p class = "second-p">没有待登记的薪酬发放信息！<a href = "pages/user/index.jsp">返回首页</a></p>
            </div>
        </c:if>
                ...
                <c:forEach items = "${checkUserList}" var = "userInfo" varStatus = "stat">
                    <tr>
                        ...
                        <td style = "text-align: center">
                            <a href = "userInfo/showDetails?archiveId=${userInfo.archiveId}&message=check">登记</a>
                        </td>
                    </tr>
