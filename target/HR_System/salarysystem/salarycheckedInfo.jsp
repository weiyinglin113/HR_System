...
<div class = "main">
    <p class = "first-p">您正在做的业务是：人力资源>>薪酬标准管理>>薪酬标准查询</p>
    ...
    <c:if test = '${sessionScope.user.role.equals("薪资专员")||sessionScope.user.role.equals("薪资经理")}'>
        <c:if test = "${empty checkedSalInfoList}">
            <div class = "msg">
                <p class = "second-p">没有查到已通过复核薪酬信息！<a href = "pages/user/index.jsp">返回首页</a></p>
            </div>
        </c:if>

        <c:if test = "${!empty checkedSalInfoList}">
            <p style = "margin-top: 60px">当前已通过的薪酬总数：${checkedSalInfoList.size()}例</p>
            ...
            <table>
                ...
                <c:forEach items = "${checkedSalInfoList}" var = "salInfo" >
                    <tr>
                        ...
                        <td style = "text-align: center">
                            <a href = "salInfo/showDetails?salaryId=${salInfo.salaryId}&message=checked">查看详情</a>
                        </td>
                    </tr>
